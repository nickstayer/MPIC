...
public class DealPayload
{
    ...
    public static string GetNotNegativeDealsPayload(long afterId = Consts.ID_BEFORE_START_ID, int limit = Consts.JSON_ENTRIES_LIMIT)
    {
        var sb = new StringBuilder();
        ...
        sb.Append(@"""filter"":
    {
        ...
        ""config"":{
            ...
            ""termGroup"":
            {
                ""contentType"":""FilterTermGroup"",
                ""join"":""and"",
                ""terms"":[{""contentType"":""FilterTermEnum"",""field"":""result"",""comparison"":""not_equals"",""value"":[""negative""]}]
            }
        },
        ""program"":{""id"":""7"",""contentType"":""Program""}
    }");
